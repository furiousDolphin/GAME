...
class Game():
        ...
        if self.projectiles:
            for projectile in self.projectiles.copy():
                ...
                if projectile.update():
                    ...
                    self.centroid_vectors.append((projectile.centroid.copy(), projectile.intersection.copy()))
    ...
    def render_method(self):
        ...
        if self.centroid_vectors:
            for p1, p2 in self.centroid_vectors:
                pygame.draw.line(self.surf, "#ff0000", (p1[0] - self.offset[0], p1[1] - self.offset[1]),
                                                       (p2[0] - self.offset[0], p2[1] - self.offset[1]))
